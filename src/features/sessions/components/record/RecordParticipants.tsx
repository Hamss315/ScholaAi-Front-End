  ...
  return (
    <div className="flex gap-4 mb-8">
      <Card className="flex-1 p-4 flex items-center gap-3">
        <Avatar>
          <AvatarFallback className="bg-[#3B82F6] text-white">{sessionData.studentInitials}</AvatarFallback>
        </Avatar>
        <div>
      ...
      <Card className="flex-1 p-4 flex items-center gap-3">
        <Avatar>
          <AvatarFallback className="bg-[#8B5CF6] text-white">{sessionData.teacherInitials}</AvatarFallback>
        </Avatar>
        <div>
