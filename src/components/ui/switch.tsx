    ...
    <SwitchPrimitive.Root
      ...
      className={cn(
        "peer inline-flex h-[1.15rem] w-8 shrink-0 items-center rounded-full border border-transparent transition-all outline-none disabled:cursor-not-allowed disabled:opacity-50 " +
          "data-[state=checked]:bg-primary data-[state=unchecked]:bg-[var(--switch-background)] " +
      ...
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block size-4 rounded-full bg-white shadow-sm ring-0 transition-transform " +
            ...
            "dark:data-[state=checked]:bg-primary-foreground dark:data-[state=unchecked]:bg-white"
        )}
      />
    </SwitchPrimitive.Root>
  );
